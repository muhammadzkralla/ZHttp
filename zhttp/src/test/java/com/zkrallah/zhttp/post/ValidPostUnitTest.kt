...
class ValidPostUnitTest {
    ...
    fun `test list request`() = runBlocking {
        ...
        val response = client.post<List<Post>>("posts", posts)
    ...
    fun `test params request`() = runBlocking {
        ...
        val response = client.post<Post>("post/${post.id}",
            post
        )
    ...
    fun `test complex request`() = runBlocking {
        ...
        val response = client.post<Complex>("complex", complex)
    ...
    fun `test map request`() = runBlocking {
        ...
        val response = client.post<Map<Any, Any>>("map", map)
